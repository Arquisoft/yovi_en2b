...
public class RecordedSimulation extends Simulation {
  ...
  // Add the feeder to load the users
      ...
      http("request_0")
        ...
        .resources(
          http("request_1")
            ...
            .headers(headers_1)
            .body(RawFileBody("yovi/recordedsimulation/0001_request.json")),
          http("request_2")
            .get(uri2 + "/vite.svg")
            .headers(headers_2),
          http("request_3")
      ...
      http("request_7")
        ...
        .resources(
          ...
          http("request_9")
            ...
            .headers(headers_2),
          http("request_10")
            .get("/game/api/games/a4b8c792-dad8-42e9-8f30-e83c5494aa0d")
            .headers(headers_10)
        ),
      pause(10),
      http("request_11")
        .options("/game/api/games/a4b8c792-dad8-42e9-8f30-e83c5494aa0d/move")
        .headers(headers_7)
        .resources(
          http("request_12")
            .post("/game/api/games/a4b8c792-dad8-42e9-8f30-e83c5494aa0d/move")
            .headers(headers_1)
