...
- Usability (High) -> <<QS-01>>, <<QS-02>>
- Performance efficiency (High) -> <<QS-03>>, <<QS-04>>, <<QS-05>>
- Maintainability (High) -> <<QS-06>>, <<QS-07>>
- Reliability (High) -> <<QS-08>>, <<QS-09>>
- Security (Low) -> <<QS-10>>, <<QS-11>>, <<QS-12>>
- Compatibility / Interoperability (Medium) -> <<QS-13>>
- Operability / Observability (Medium) -> <<QS-14>>
- Documentation quality (High) -> <<QS-15>>
