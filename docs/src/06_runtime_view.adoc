...
image::../images/registration_history.svg[alt="Registration Sequence", width=600, align="center"]
...
==== Quality Context (Stimulus-Response)
[cols="1,3"]
|===
| **Source** | Human Player
...
| **Response** | The move is validated, the state is persisted, and the board is updated
| **Response Measure** | The UI reflects the new state in less than [TODO: X seconds]
|===
...
image::../images/db_logic.svg[alt="Registration Sequence", width=600, align="center"]
