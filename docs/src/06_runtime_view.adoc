...
*5.* If the game ended the Web Application updates the game state in the [TODO: Database Name/Type] and reflects the new state in the Web Frontend anyways.
...
*2.* Web Application (TypeScript) receives the request and validates the information with the data on the [TODO: Database Name/Type].

*3.* When the registered User requests their history, the Web Application queries the [TODO: Database Name/Type] for the raw data.
